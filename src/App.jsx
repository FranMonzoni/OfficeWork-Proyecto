...
const MenuDropdown = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      <button 
        onClick={toggleMenu}
        className="p-3 bg-gray-800 rounded-lg border border-gray-700 hover:bg-gray-700 transition-all duration-200 shadow-lg"
      >
      ...
      <div className={`absolute top-full right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-xl transition-all duration-200 ${isOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-2'}`}>
        <a href="/login" className="block px-4 py-3 text-white hover:bg-gray-700 transition-colors duration-150 rounded-t-lg">Iniciar Sesión</a>
        <a href="/administrador" className="block px-4 py-3 text-white hover:bg-gray-700 transition-colors duration-150 rounded-b-lg">Panel de Administración</a>
      </div>
    </div>
  );
};
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* HERO SECTION */}
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10"></div>
        <div className="relative max-w-7xl mx-auto text-center">
          <p className="text-sm font-medium text-blue-400 uppercase tracking-wider mb-4 animate-fade-in">
            Espacios de trabajo
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            <div className="flex items-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 rounded-full text-sm text-gray-300 hover:bg-gray-700 transition-colors duration-200">
      ...
      <div className="px-6 pb-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {error && (
            <div className="col-span-full text-center py-12">
              <div className="text-red-400 bg-red-900/20 border border-red-800 rounded-lg px-4 py-3 inline-block">
                {error}
              </div>
            </div>
          )}
          ...
          {!loading && !error && filteredEspacios.map(espacio => (
            <div key={espacio.id} className={`card p-6 hover:shadow-card-hover transition-all duration-300 ${!espacio.available ? 'opacity-75' : ''}`}>
              <div className="relative mb-4">
                <div 
                  className="h-32 rounded-lg flex items-center justify-center relative overflow-hidden"
                  style={{ background: espacio.color || '#1e40af' }}
                >
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {espacio.features && espacio.features.slice(0, 3).map((feature, index) => (
                    <span key={index} className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-full border border-gray-700">
                      {feature}
                    </span>
                  ))}
      ...
      {/* FOOTER INFO */}
      <div className="bg-gray-800 border-t border-gray-700 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:+543564472828" className="btn-primary flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <a href="mailto:mauriciomonzoni@hotmail.com" className="btn-secondary flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
