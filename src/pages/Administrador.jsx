...
const Administrador = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Header del Admin */}
      <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700 sticky top-0 z-40 shadow-xl backdrop-blur-sm">
        <div className="px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white font-display bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => navigate('/')}
                className="group relative px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-all duration-200 flex items-center gap-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl transform transition-all duration-300 scale-100 animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="group">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                  >
              ...
              <div className="group">
                ...
                <textarea
                  ...
                  required
                  rows="3"
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700 resize-none"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group">
                  ...
                  <input
                    ...
                    placeholder="Ej: 18 m²"
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                  />
                </div>
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                  />
                </div>
                ...
                <div className="group">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-full h-12 bg-gray-700/50 border border-gray-600 rounded-lg cursor-pointer transition-all duration-200 hover:bg-gray-700"
                    />
                    <span className="text-xs text-gray-400 font-mono">{formData.color}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                  />
                </div>
                ...
                <div className="group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                  />
                </div>
              </div>
              ...
              <div className="group">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200 hover:bg-gray-700"
                />
              </div>
              ...
              <div className="flex gap-3 pt-6 border-t border-gray-700">
                ...
                <button type="button" onClick={resetForm} className="flex-1 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center gap-2">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <line x1="18" y1="6" x2="6" y2="18"/>
                    <line x1="6" y1="6" x2="18" y2="18"/>
                  </svg>
      ...
      <div className="p-6">
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-bold text-white font-display bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                Lista de Espacios ({espacios.length})
              </h3>
              <p className="text-gray-400 text-sm mt-1">Gestiona todos tus espacios de trabajo</p>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="px-3 py-1 bg-red-600/20 text-red-400 rounded-full text-xs font-medium border border-red-600/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {espacios.map(espacio => (
            <div key={espacio.id} className="group relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-6 hover:border-gray-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
              ...
              <div className="relative">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      ></div>
                      <h4 className="text-lg font-bold text-white font-display group-hover:text-blue-400 transition-colors duration-200">
                        {espacio.name}
                      </h4>
                    </div>
                    <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-blue-400 bg-blue-600/20 rounded-full border border-blue-600/30">
                  ...
                  <div className="flex flex-col items-end">
                    <span className={`inline-flex items-center gap-1 px-3 py-1 text-xs font-medium rounded-full border ${
                      ...
                      <div className={`w-2 h-2 rounded-full ${
                        espacio.available ? 'bg-green-400' : 'bg-red-400'
                ...
                {/* Descripción */}
                <p className="text-gray-300 text-sm mb-4 leading-relaxed line-clamp-2">{espacio.desc}</p>
                
                {/* Metadatos */}
                <div className="flex items-center gap-4 text-sm text-gray-400 mb-4">
                  <span className="flex items-center gap-2 px-2 py-1 bg-gray-700/50 rounded-lg">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {espacio.features.slice(0, 3).map((feature, index) => (
                        <span key={index} className="px-2 py-1 bg-gradient-to-r from-gray-700 to-gray-600 text-gray-300 text-xs rounded-full border border-gray-600 hover:border-gray-500 transition-colors duration-200">
                          {feature}
                        </span>
                      ))}
